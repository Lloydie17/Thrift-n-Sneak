...
const showCart = () => {
  ...
  var addToCartButtons = document.querySelectorAll(".product-section-button");
...
let casualsBtn=document.getElementById("casuals");
casualsBtn.onclick=function(){
    window.location.href="casuals.html";
}
